...
class mkfs:
    ...
    def execute(self):
        ...
        if self.id != "":
            ...
            self.console = "No ha ingresado el id de la particion\n"
            return self.console
        
    def createFileSystem(self):
        if self.fs =="2fs":
            return self.createFileSystem2fs()
        else:
            #print("Tipo de particion no valida")
            self.console = "Tipo de particion no valida\n"
            return self.console
        ...
        if self.type == "full":
            with open(path_mount,"rb+") as f:
                ...
                if partition1[5].decode('utf-8').rstrip("\x00")==part_m.name_partition:
                    ...
                    self.console = "Sistema de archivos creado correctamente\n"
                    return self.console
